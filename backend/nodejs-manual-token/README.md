# Node.js Manual Token Generation Sample

Educational example showing OAuth 2.0 client credentials flow with custom token management.

## Features

- ✅ **Manual token generation** - Direct HTTP POST to `/auth/token`
...
- Custom token management requirements
...
- Token generation via HTTP POST with Basic Auth
